...
const gradientStyle = {
    background: `linear-gradient(45deg, ${b.data.AuthorWorklog.activityMeta.map((item)=>item.fillColor)} 30%, #ff8e53 90%)`,
  ...
  return (
    <div className='container'>
       ...
       <div className='date-dropdown'>
        ...
        <div className='charts-class' style={{display:"flex", justifyContent:"space-evenly",padding:"2px", margin:"60px", border:"1px solid #D3D3D3", borderRadius:"4px", height:"500px"}}>
      <ActivityBarChart data={cardData}></ActivityBarChart>
        <ActivityPieChart data={cardData}></ActivityPieChart>
       <div className='radial'><ActivityRadialChart data={cardData}></ActivityRadialChart></div> 
       <ActivityLineChart data={dayWiseData} date={selectValDate}></ActivityLineChart>
       <ActivityRadarChart data={dayWiseData} date={selectValDate}></ActivityRadarChart>
       <ActivityAreaChart  data={dayWiseData} date={selectValDate}></ActivityAreaChart>
